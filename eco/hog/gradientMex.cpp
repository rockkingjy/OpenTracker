         ...
         int nOrients, int softBin, bool full, float clip)
{
  ...
  // perform four normalizations per spatial block, 36xnb dimensions
          ...
          int nOrients, int softBin, float clip)
{
  ...
  // normalized histograms and texture channels, total 18+9+4=31 dimensions
  hogChannels(H + nbo * 0, R1, N, hb, wb, nOrients * 2, clip, 1); //18 dimensions
